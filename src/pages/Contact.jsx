          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="p-6 rounded-xl filament-border bg-card/50">
              ...
              <div className="space-y-4">
                <a href="mailto:info@fraud-shield-recovery.com" className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-lg bg-primary/5 border border-primary/10 flex items-center justify-center">
                    <Mail className="w-4 h-4 text-primary" />
                  </div>
                  <div>
                    <p className="text-sm font-medium group-hover:text-primary transition-colors">info@fraud-shield-recovery.com</p>
